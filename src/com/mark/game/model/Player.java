...
public class Player {
	...
	private static final int JUMP_VELOCITY = -600; //How high the player jumps
	private static final int ACCEL_GRAVITY = 1800; //How fast the player falls down
	...
	public Player(float x, float y, int width, int height)
	{
		...
		ground = new Rectangle(0, 405, 800, 45); //Tells us if the player is standing on the ground - so if it can jump or duck
		rect = new Rectangle();
